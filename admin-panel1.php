...
if(isset($_POST['docsub']))
{
  ...
  $sql_email="SELECT * FROM `doctb` WHERE `email`= '$demail'";
  $db_email = mysqli_query($con, $sql_email);
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> SJS Hospital </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#del-doc" id="list-doc-list"  role="tab" data-toggle="list" aria-controls="home">Deleted Doctors</a>
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
        <div class="container-fluid container-fullw bg-white" >
            ...
            <div class="tab-pane fade" id="del-doc" role="tabpanel" aria-labelledby="list-home-list">
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="">
          <div class="row">
            ...
            <span><?php echo "<script>alert('Email already taken!');</script>";  unset($email_error);?></span>
           <?php endif ?>
                </div><br><br>
