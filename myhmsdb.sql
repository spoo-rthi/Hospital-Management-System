...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2022 at 03:49 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `demp` (IN `doctor1` VARCHAR(50))  select pid,fname,lname,ID,appdate,apptime,disease,allergy,prescription from prestb where doctor=doctor1$$
...
(1, 14, 'Ram', 'Kumar', 'Male', 'ram@gmail.com', '9876543210', 'Abbis', 1500, '2022-02-08', '10:00:00', 0, 1),
(15, 15, 'abishek', 'g', 'Male', 'abhishek@gmail.com', '8790578453', 'arun', 600, '2022-02-06', '08:00:00', 1, 1),
(16, 16, 'vani', 's', 'Female', 'vani@gmail.com', '9785379688', 'Dinesh', 700, '2022-02-10', '12:00:00', 1, 1),
(17, 17, 'tushar', 'sharma', 'Male', 'tushar@gmail.com', '9785379688', 'ashok', 500, '2022-02-06', '08:00:00', 1, 0),
(1, 18, 'Ram', 'Kumar', 'Male', 'ram@gmail.com', '9876543210', 'ashok', 500, '2022-02-09', '08:00:00', 1, 1),
(1, 19, 'Ram', 'Kumar', 'Male', 'ram@gmail.com', '9876543210', 'Abbis', 1500, '2022-03-24', '12:00:00', 1, 1),
(1, 20, 'Ram', 'Kumar', 'Male', 'ram@gmail.com', '9876543210', 'Abbis', 1500, '2022-03-29', '10:00:00', 1, 1);
...
('vani', 'vani@gmail.com', '9785379688', 'very nice service'),
('tushar', 'tushar@gmail.com', '9785379688', 'better services than other hospitals!');

-- --------------------------------------------------------

--
-- Table structure for table `del_doc`
--

CREATE TABLE `del_doc` (
  `name` varchar(30) NOT NULL,
  `email` varchar(30) NOT NULL,
...
--
-- Dumping data for table `del_doc`
--

INSERT INTO `del_doc` (`name`, `email`, `specialization`) VALUES
('siri', 'siri@gmail.com', 'General'),
('Tiwary', 'tiwary@gmail.com', 'Pediatrician'),
('siri', 'siri@gmail.com', 'General'),
('jerry', 'jerry@gmail.com', 'Cardiologist'),
('jerry', 'jerry@gmail.com', 'Neurologist'),
('jerry', 'jerry@gmail.com', 'General'),
('jerry', 'jerry@gmail.com', 'General'),
('jerry', 'jerry@gmail.com', 'General'),
('jerry', 'jerry@gmail.com', 'General');
...
--
DELIMITER $$
CREATE TRIGGER `tr_del` AFTER DELETE ON `doctb` FOR EACH ROW INSERT into del_doc VALUES(old.username, old.email, old.spec)
$$
DELIMITER ;
...
('arun', 15, 15, 'abishek', 'g', '2022-02-06', '08:00:00', 'cough', 'nothing', 'bed rest');
